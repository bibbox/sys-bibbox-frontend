		...
		return (
			<div className={"app " + this.props.data.status}>
                ...
                <div className="app-footer">
				    <span className="app-footer-button info" onClick={() => { window.location = '/instance/id/' + this.props.data.instanceid + '/info'; }}>
					   <span>
						  <span className="icon">
				  ...
				  <span className="app-footer-button open" onClick={() => { const win = window.open(open, '_blank'); win.focus(); }}>
					  <span>
						  <span className="icon">
							  <svg viewBox="0 0 1000 1000">
